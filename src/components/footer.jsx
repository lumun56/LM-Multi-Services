  ...
  return (
    <footer>
      ...
      <div ClassName="flex flex">
        Like & Follow on:{"  "}
        <a href="https://www.facebook.com/Sir.O.See.Production">
          <img src={FBicon} width={30} height={30}></img>
        </a>
        {"  "}
        <a href="https://www.instagram.com/siroseemms/">
          <img src={IGicon} width={30} height={30}></img>
        </a>
        {"  "}
        <a href="https://www.tiktok.com/@siroseemms">
          <img src={TTicon} width={30} height={30}></img>
        </a>
        {"  "}
        <a href="https://www.youtube.com/@luismunoz78">
